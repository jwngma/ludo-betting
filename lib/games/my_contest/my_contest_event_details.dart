...
class MyContestEventDetailsPage extends StatefulWidget {
  static const String routeName = "/MyContestEventDetailsPage";
  final EventModel eventModel;

  MyContestEventDetailsPage({
    this.eventModel,
  });

  @override
  _MyContestEventDetailsPageState createState() =>
      _MyContestEventDetailsPageState(this.eventModel);
}

class _MyContestEventDetailsPageState extends State<MyContestEventDetailsPage> {
  final EventModel eventModel;
